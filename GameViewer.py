...
model.load_state_dict(torch.load(r'C:\Users\david\OneDrive\Pictures\IEEE\CNNmodel.pth'))
model.eval()
...
cap = cv2.VideoCapture(1)  # 0 for default camera, you can change it if you have multiple cameras
